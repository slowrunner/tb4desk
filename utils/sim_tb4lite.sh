...
echo "ros2 launch turtlebot4_ignition_bringup ignition.launch.py model:=lite world:=mymaze2"
ros2 launch turtlebot4_ignition_bringup ignition.launch.py model:=lite world:=mymaze2
