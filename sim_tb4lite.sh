...
echo "ros2 launch turtlebot4_ignition_bringup ignition.launch.py model:=lite world:=mymaze"
ros2 launch turtlebot4_ignition_bringup ignition.launch.py model:=lite world:=mymaze
